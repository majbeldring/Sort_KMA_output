'''
Maj Beldring Henningsen, Thesis project
"Rapid Identification of Nanopore sequenced data"

To:
Sort KMA output, only showing Template name and template_ID

Note to self:
To run in CMD.exe "python sort_output.py"
Be in the same folder as the script.

Data sheet must also be in the same folder.
